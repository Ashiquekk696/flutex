    ...
    return GestureDetector(
      onTap: () {
        Get.toNamed(RouteHelper.projectDetailsScreen,
            arguments: projectModel.data?[index].id ?? 0);
      },
      child: Card(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (projectModel.data![index].deadline != null)
                          Text(
                            '${projectModel.data![index].progress ?? 0.0}%',
                            style: const TextStyle(
                                fontSize: Dimensions.fontDefault,
                                color: ColorResources.blueGreyColor),
                          ),
                    ...
                    ClipRRect(
                      ...
                      child: LinearProgressIndicator(
                          ...
                          value: double.parse(
                                  (projectModel.data?[index].progress ?? 0)
                                      .toString()) *
                              0.01,
                          color: ColorResources.projectStatusColor(
                              projectModel.data?[index].status ?? ""),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          projectModel.data?[index].company ?? "Demo Company",
                          style: const TextStyle(
                              fontSize: Dimensions.fontDefault,
                              color: ColorResources.blueGreyColor),
                        ),
