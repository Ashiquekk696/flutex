...
class Overview {
  ...
  Overview.fromJson(dynamic json) {
    _perfexLogo = json['perfexLogo'];
    _perfexLogoDark = json['perfex_logo_dark'];
    _totalInvoices = json['totalInvoices'];
    _invoicesAwaitingPaymentTotal = json['invoicesAwaitingPaymentTotal'];
  ...
  Map<String, dynamic> toJson() {
    ...
    map['perfexLogo'] = _perfexLogoDark;
    map['totalInvoices'] = _totalInvoices;
    map['invoicesAwaitingPaymentTotal'] = _invoicesAwaitingPaymentTotal;
...
class Data {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_proposals != null) {
      map['proposal'] = _proposals?.map((v) => v.toJson()).toList();
    }
    if (_projects != null) {
