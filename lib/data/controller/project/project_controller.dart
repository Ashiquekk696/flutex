...
class ProjectController extends GetxController {
  ...
  ProjectController({required this.projectRepo, required this.customerRepo});
  ...
  Future<void> loadProjects() async {
    isLoading = true;
    update();
    projectRepo.getProjectDataStream().listen((projectResponseModel) {
      projectsModel = projectResponseModel;
      update();
    });
    isLoading = false;
    update(); 
  ...
  Future<void> submitProject(BuildContext context) async {
    ...
    await projectRepo.addProjectDataToFirestore(projectModel);
    projectAddedSuccesfully();
  }
